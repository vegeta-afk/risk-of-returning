...
function Returns({ onNewRequest }) {
  return (
    <div className="page-wrap">
      <p className="breadcrumb">Home / Seller Portal / Returns</p>
      <div className="table-card">
        ...
        <table className="returns-table">
          <thead>
            <tr>
              <th>Request ID</th><th>Customer</th><th>Item</th><th>Location</th><th>Status</th><th>Risk</th>
            </tr>
          </thead>
          <tbody>
            {dummyReturns.map((r) => (
              <tr key={r.id}>
                <td>{r.id}</td><td>{r.customer}</td><td>{r.item}</td><td>{r.location}</td>
